...
{% include main_title.html text="Fall 26 Sessions" %}

In the Fall of 2026 we are hosting a problem-solving session every Friday from
...
**Friend Center Room 006**. You will need a laptop and optionally pen
