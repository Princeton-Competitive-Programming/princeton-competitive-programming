...
{% include main_title.html text="ICPC Team Local Qualifier 2026" %}

If you are interested in competing in the [ICPC contests]({{ site.baseurl
}}/icpc) in 2026, the local qualifier will happen **Friday October 9 at
5:00pm** and it will take place in **Friend Center 006**. This will consist of a
...
Greater NY Regional on **Sunday, November 8** (details about it below).
...
place **Sunday, November 8** at Touro University in Manhattan. Do not sign up to
...
[here](http://acmgnyr.org/year2026/).
...
have to pick someone else). We will need to have the teams decided by
November 1 (about three weeks after the qualifier).
...
* The contest will be on the [Princeton ICPC
  ...
  Selection Contest 2026-27", and it will show up there around an hour before
